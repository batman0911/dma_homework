...
\lhead{\footnotesize 2022: DMA 02}% \lhead puts text in the top left corner. \footnotesize sets our font to a smaller size.

%\rhead works just like \lhead (you can also use \chead)
\rhead{\footnotesize Linh, Đông, Thúy} %<---- Fill in your lastnames.
